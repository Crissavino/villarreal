    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="container" enctype='multipart/form-data' method="post" action="{{route('dashboard-store-article')}}" >
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group bannerDiv">
                                ...
                                <div class="bannerAgregado d-none">
                                    <label class="mt-3" for="">Banner seleccionado</label><br>
                                    <div class="mt-5 mb-4 bannerAgregadoDiv">
                                        <img src="" class="bannerImage" style="width: 100%; height: 450px; border-radius: 0.25em;" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
